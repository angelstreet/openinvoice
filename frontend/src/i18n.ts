...
const translations = {
  en: {
    ...
    ocrTextTab: 'OCR Text',
    textMethod: 'Text Extraction',
    fieldMethod: 'Field Extraction',
  ...
  fr: {
    ...
    confirmDelete: 'Supprimer cette facture ?',
    // Pipeline & Feedback
    fieldsTab: 'Champs',
    pipelineTab: 'Pipeline',
    ocrTextTab: 'Texte OCR',
    textMethod: 'Extraction texte',
    fieldMethod: 'Extraction champs',
    totalDuration: 'Durée',
    inputTokens: 'Entrée',
    outputTokens: 'Sortie',
    estimatedCost: 'Coût',
